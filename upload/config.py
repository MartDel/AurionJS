...
CALENDAR_ID = json.load(
    open('credentials/google_calendar.json', encoding='utf-8'))['CALENDAR_ID']
...
ICAL_FEEDS = [
    {'source': 'ics', 'destination': CALENDAR_ID, 'files': True},
    #   ...
]
...
CREDENTIAL_PATH = 'credentials/google_tokens.json'
